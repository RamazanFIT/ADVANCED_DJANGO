...
class ResumeAnalyzer:
    ...
    def _load_skill_patterns(self):
        # Здесь можно загрузить список навыков из файла или БД
    ...
    def _extract_experience(self, doc):
        # Используем NER для извлечения организаций и дат
        experience = []
        for ent in doc.ents:
    ...
    def _calculate_score(self, doc):
        # Базовый алгоритм подсчета рейтинга
        score = 0
        ...
        return min(score, 10.0)  # Максимальный балл 10
